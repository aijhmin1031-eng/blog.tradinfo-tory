// ★ 2026-09-06 에 다시 썼다. 이 셋이 **검색 결과에 그대로 나가는 문장**이다 —
//   제목 꼬리(`도토리경제 | …`)·og:title·기본 설명. 개편으로 화면은 전부 바뀌었는데
//   여기만 옛 개념이 남아 있었다: 캐릭터 표어, 「숫자를 매일 줍는」(규약 5 의 금지어),
//   「브리핑 블로그」. 도메인 교체 직전에 잡았다.
export const SITE = {
  name: '도토리경제',
  nameEn: 'Dotori Economy',
  tagline: '기업 분석과 실무 계산 도구',
  taglineSub: '기업 분석과 실무 계산 도구',
  description:
    '상장기업의 정기보고서를 분기 단위로 이어 분석하여 보고서로 발행하고, 공공조달·무역·자금 실무의 계산 도구를 제공합니다. 배경이 되는 거시·시장 지표는 매일 갱신해 기준일·출처와 함께 공개합니다.',
