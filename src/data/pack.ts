...
const p3: PackItem[] = [
  { slug: 'laptop', name: '노트북', desc: '화면이 비어 있는 노트북을 비스듬히 본 그림입니다. 재택근무와 온라인 강의, 업무 도구를 다루는 글의 대표 이미지로 씁니다. 화면이 빈 채라 캡처나 문구를 얹기에도 좋습니다.', keywords: ['노트북', '랩탑', '컴퓨터', '재택근무', '업무', 'laptop'] },
  { slug: 'notebook-pen', name: '노트와 볼펜', desc: '스프링 노트 위에 볼펜이 놓인 그림입니다. 기록과 메모, 공부와 계획 세우기를 이야기하는 글이나 서식 자료에 어울립니다.', keywords: ['노트', '수첩', '볼펜', '메모', '기록', '필기', 'notebook pen'] },
  { slug: 'clipboard', name: '체크리스트 클립보드', desc: '체크 표시 세 개가 찍힌 클립보드입니다. 점검표와 준비물, 절차 안내와 마감 확인을 다루는 자료에 씁니다.', keywords: ['클립보드', '체크리스트', '점검표', '할일', '체크', 'checklist clipboard'] },
  { slug: 'desk-calendar', name: '탁상 달력', desc: '철끈으로 묶인 탁상 달력이 세워져 있는 그림입니다. 일정과 마감, 월간 계획을 안내하는 글에 씁니다. 날짜 칸이 비어 있어 어떤 달에도 씁니다.', keywords: ['달력', '탁상달력', '일정', '캘린더', '마감', '스케줄', 'calendar'] },
  { slug: 'coffee-mug', name: '커피 머그', desc: '김이 오르는 커피 머그컵입니다. 아침 루틴과 휴식, 카페와 일상 이야기를 다루는 글에 두루 씁니다.', keywords: ['커피', '머그', '컵', '카페', '아침', '휴식', 'coffee mug'] },
  { slug: 'document-folder', name: '서류 폴더', desc: '서류가 꽂힌 종이 폴더입니다. 자료 정리와 보관, 제출 서류와 아카이브를 설명할 때 씁니다.', keywords: ['폴더', '서류', '파일', '문서', '자료', '정리', 'folder document'] },
  { slug: 'sticky-notes', name: '포스트잇', desc: '겹쳐 놓인 접착 메모지입니다. 아이디어와 할 일, 짧은 알림을 다루는 글이나 발표 자료의 장식으로 씁니다.', keywords: ['포스트잇', '메모지', '접착메모', '아이디어', '할일', 'sticky notes'] },
  { slug: 'presentation-board', name: '발표용 차트 보드', desc: '막대그래프가 그려진 이젤형 발표 보드입니다. 실적 보고와 강의, 브리핑과 제안 발표를 다루는 자료에 맞습니다.', keywords: ['발표', '프레젠테이션', '차트', '보드', '그래프', '강의', 'presentation chart'] },
  ...
  { slug: 'printer', name: '프린터', desc: '종이가 빠져나오는 탁상 프린터입니다. 출력과 인쇄, 서류 발급과 사무 기기를 다루는 글에 씁니다.', keywords: ['프린터', '인쇄', '출력', '복합기', '사무기기', 'printer'] },
  { slug: 'desk-lamp', name: '책상 스탠드', desc: '불이 켜진 관절형 책상 스탠드입니다. 야근과 새벽 작업, 집중과 서재 분위기를 담는 글에 어울립니다.', keywords: ['스탠드', '조명', '책상등', '램프', '야근', '집중', 'desk lamp'] },
  { slug: 'magnifier-doc', name: '돋보기와 서류', desc: '서류 더미를 돋보기로 들여다보는 그림입니다. 검토와 감사, 조사와 팩트체크를 이야기하는 글의 대표 이미지로 씁니다.', keywords: ['돋보기', '검토', '조사', '분석', '감사', '확인', 'magnifier document'] },
  { slug: 'stamp', name: '결재 도장', desc: '도장과 인주가 함께 놓인 그림입니다. 승인과 결재, 계약과 공증을 다루는 글이나 행정 안내 자료에 씁니다.', keywords: ['도장', '결재', '승인', '인주', '계약', '날인', 'stamp approval'] },
  { slug: 'envelope', name: '봉투', desc: '봉랍으로 봉한 편지 봉투입니다. 안내문과 통지, 초대와 문의 메일을 이야기하는 글에 씁니다.', keywords: ['봉투', '편지', '메일', '우편', '초대장', '문의', 'envelope letter'] },
  { slug: 'gear-cogs', name: '맞물린 톱니바퀴', desc: '크기가 다른 톱니바퀴 세 개가 맞물린 그림입니다. 자동화와 절차, 시스템과 협업 구조를 설명할 때 씁니다.', keywords: ['톱니바퀴', '기어', '자동화', '시스템', '프로세스', '협업', 'gears'] },
  { slug: 'wall-clock', name: '벽시계', desc: '테두리가 굵은 둥근 벽시계입니다. 시간 관리와 마감, 근무 시간과 일정 안내를 다루는 글에 씁니다.', keywords: ['시계', '벽시계', '시간', '마감', '일정', '근무시간', 'wall clock'] },
];
