...
- **Tier A: 15 / 55 완료**(전부 8/25, 계정A) · 대기 40
- **Tier B: 0 / 31 완료** · 대기 31
- **총 15 / 86.** 진행중(`[진행중·*]`) 표시 **없음** = 지금 아무도 잡고 있지 않다. 위에서부터 집으면 된다.
- 완료분 실측: 708~783자 → **1,391~1,814자**(평균 약 1,600자). 기준은 **1,500자 내외**이고
  미달해도 새 사실이 충분하면 통과다(소유주 지시).
- **다음 두 편**: `overseas-direct-purchase-tax`(817자) · `forwarder-vs-customs-broker`(820자).
