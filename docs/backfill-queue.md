...
- **Tier A: 9 / 55 완료**(전부 8/25, 계정A) · 대기 46
- **Tier B: 0 / 31 완료** · 대기 31
- **총 9 / 86.** 진행중(`[진행중·*]`) 표시 **없음** = 지금 아무도 잡고 있지 않다. 위에서부터 집으면 된다.
- 완료분 실측: 708~769자 → **1,391~1,752자**(평균 약 1,570자). 기준은 **1,500자 내외**이고
...
| [진행중·A] | 금리가 오르면 채권값은 왜 내리나…국고채 10년으로 푸는 역관계 | 780자 | `bond-price-vs-yield` |
| [진행중·A] | 관세 환급…신청하지 않으면 돌려받지 못하는 돈 | 783자 | `duty-drawback-basics` |
