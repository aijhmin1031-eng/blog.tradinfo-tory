...
- **Tier A: 35 / 55 완료**(전부 8/25, 계정A) · 대기 20
- **Tier B: 0 / 31 완료** · 대기 31
- **총 35 / 86.** 진행중(`[진행중·*]`) 표시 **없음** = 지금 아무도 잡고 있지 않다. 위에서부터 집으면 된다.
- 완료분 실측: 708~783자 → **1,391~1,814자**(평균 약 1,600자). 기준은 **1,500자 내외**이고
  미달해도 새 사실이 충분하면 통과다(소유주 지시).
- **다음 두 편**: `freight-index-reading`(932자) · `tariff-who-pays`(935자).
...
| [진행중·A] | 운임지수 읽는 법…뱃삯의 온도계는 어떻게 만들어지나 | 932자 | `freight-index-reading` |
| [진행중·A] | 관세는 정말 상대국이 내는 걸까…관세 부담의 경제학 | 935자 | `tariff-who-pays` |
| [진행중·A] | 인플레이션의 두 얼굴…끌려서 오르는 물가, 밀려서 오르는 물가 | 975자 | `inflation-two-faces` |
| [진행중·A] | 환헤지 첫걸음…선물환과 옵션, 중소 수출기업은 무엇이 맞나 | 983자 | `fx-hedge-basics` |
