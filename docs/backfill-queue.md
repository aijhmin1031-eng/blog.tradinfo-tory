...
- **Tier A: 11 / 55 완료**(전부 8/25, 계정A) · 대기 44
- **Tier B: 0 / 31 완료** · 대기 31
- **총 11 / 86.** 진행중(`[진행중·*]`) 표시 **없음** = 지금 아무도 잡고 있지 않다. 위에서부터 집으면 된다.
- 완료분 실측: 708~783자 → **1,391~1,814자**(평균 약 1,600자). 기준은 **1,500자 내외**이고
  미달해도 새 사실이 충분하면 통과다(소유주 지시).
- **다음 두 편**: `trade-payment-three-ways`(787자) · `cofix-explained`(803자).
...
| [진행중·A] | 무역대금 결제의 세 가지 길…송금·추심·신용장 총정리 | 787자 | `trade-payment-three-ways` |
| [진행중·A] | 코픽스…내 대출 금리를 정하는 낯선 이름 | 803자 | `cofix-explained` |
| [진행중·A] | 인코텀즈 2020 총정리…11가지 조건, 한 가지 질문 | 805자 | `incoterms-2020-guide` |
| [진행중·A] | 면세 한도 800달러…술·담배·향수는 따로 계산한다 | 806자 | `duty-free-allowance-800` |
